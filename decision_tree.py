...
def save_house_files(house: str) -> None:
    ...
    for file_name in file_names:
        ...
        signal_series.to_pickle(
            tabeas_path + 'data/converted/' + house + '/' + re.sub("\.dat$", '', file_name) + '.pkl')
...
def load_house_files() -> Dict:
    ...
    for house_name in house_names:
        ...
        for file_name in file_names:
            ...
            files[house_name][appliance_name] = pd.read_pickle(
                tabeas_path + 'data/converted/' + house_name + '/' + file_name)
...
if __name__ == '__main__':
    ...
    # train the model
    tree_model = model_1(
        df=df[training_house],
        appliance=training_appliance_name,
        percentage_training_set=0.70,
        plot_loss=True
    )
